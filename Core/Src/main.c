...
/* Definitions for rngTask */
osThreadId_t rngTaskHandle;
...
/* Definitions for randomNumberQueue */
osMessageQueueId_t randomNumberQueueHandle;
const osMessageQueueAttr_t randomNumberQueue_attributes = {
  .name = "randomNumberQueue"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_startPolling */
/**
...
/* USER CODE BEGIN Header_sendRandomNumberTask */
/**
...
void sendRandomNumberTask(void *argument)
{
  ...
  /* USER CODE END sendRandomNumberTask */
}
